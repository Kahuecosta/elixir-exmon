defmodule Exmon.Game.Actions.Heal do
  ...
  defp set_life(life, player) when life > 100, do: update_lplayer_life(player, 100)
  defp set_life(life, player) when life < 100, do: update_lplayer_life(player, life)

  defp update_lplayer_life(player, life) do
    player
    |> Game.fetch_player()
    |> Map.put(:life, life)
